    ...
    <View style={{flex: 1, backgroundColor: 'white'}}>
      ...
      <Animated.ScrollView
        ...
        <View
          ...
          <DetailTabs title={t('agreedAmount')} value={t('Rs 230000')} />
          <DetailTabs title={t('agreedQuantity')} value={t('34 kg')} />
          <DetailTabs
            title={t('agreedDate')}
            value={t('22/02/2022  -  23/03/2022')}
          />
        </View>
        ...
        <View
          ...
          <Text
            ...
            <Text style={{color: 'black'}}>•</Text> {t('limitationDes')}
          </Text>
          <Text
            style={{
              ...CustomStyles.paragraph,
